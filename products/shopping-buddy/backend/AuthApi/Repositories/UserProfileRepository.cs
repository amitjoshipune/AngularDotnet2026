    ...
    public async Task<UserMeDto?> GetMeAsync(int userId)
    {
        ...
        const string profileSql = """
            SELECT Phone, DateOfBirth, Gender, EmergencyContactName, EmergencyContactPhone, Bio,
                   BuddyApplicationStatus, BuddyApplicationNotes, BuddyLocalityId
    ...
    public async Task<bool> UpsertProfileAsync(int userId, UpdateUserMeRequest request)
    {
        ...
        const string mergeProfileSql = """
            ...
            WHEN NOT MATCHED THEN
                INSERT (UserId, Phone, DateOfBirth, Gender, EmergencyContactName, EmergencyContactPhone, Bio)
                VALUES (@UserId, @Phone, @DateOfBirth, @Gender, @EmergencyContactName, @EmergencyContactPhone, @Bio);
            """;

        await connection.ExecuteAsync(mergeProfileSql, new
        {
            UserId = userId,
