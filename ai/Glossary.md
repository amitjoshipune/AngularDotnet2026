...
| Context Window | Maximum information an AI model can consider in a single request |
| Prompt | Instruction or question provided to an AI model |
| Temperature | Controls randomness and creativity of responses |
| Top-P | Controls the candidate token pool during text generation |
| System Prompt | Hidden instructions that define the AI's role and behaviour |
| User Prompt | Request entered by the end user |
| Assistant Message | Response generated by the AI model |
| Conversation History | Collection of previous messages used for context |
| Context Management | Selecting and organizing information sent to the AI |
| Token Usage | Total input and output tokens consumed during inference |
| Inference | Process of generating responses using a trained AI model |

---

# AI Conversation Flow

The following diagram summarizes how a modern AI chat application works.
...
```text
      ...
      │             │             │
      ▼             ▼             ▼
System Prompt   Conversation   Retrieved Data
                   History       (Optional RAG)
      │             │             │
      └─────────────┼─────────────┘
                    ▼
           Context Management
...
Maximum amount of information an AI can consider while generating a response.

---

### Prompt

Instruction given to an AI.
...
Controls how many candidate tokens are considered before selecting the next token.

---

### System Prompt

Hidden instructions written by the application developer.

---

### User Prompt

Instruction written by the end user.
...
Collection of previous System, User and Assistant messages.

---

### Context Management

Selecting the most relevant information before calling the AI model.

---

### Token Usage

Total number of input and output tokens consumed.

---

### Inference

Generating responses using a trained AI model.
...
### Q2. What is a Large Language Model?
...
### Q9. What is a User Prompt?

### Q10. What is an Assistant Message?

---

## Intermediate

### Q11. Difference between Prompt and System Prompt?

### Q12. Difference between Temperature and Top-P?

### Q13. Why is Context Window important?

### Q14. Why is Prompt Engineering important?

### Q15. Why does Conversation History matter?

### Q16. What is Context Management?

### Q17. What consumes tokens?

### Q18. Why is token usage important?

### Q19. What happens during inference?

### Q20. Difference between Training and Inference?

---

## Advanced (.NET / Enterprise AI)

### Q21. How would you design an AI-powered ASP.NET Core application?

### Q22. How would you reduce token usage in an enterprise application?

### Q23. How would you implement conversation history in a chat application?

### Q24. Why shouldn't an enterprise AI application send the entire database to an LLM?

### Q25. How can Context Management improve AI responses?

### Q26. Which Temperature would you choose for SQL generation and why?

### Q27. Which Temperature would you choose for marketing content and why?

### Q28. What information should an application send to an LLM for a coding assistant?

### Q29. Explain the complete lifecycle of an LLM request.

### Q30. How do System Prompt, User Prompt, Conversation History and Inference work together?
...
| Assistant Message | Employee Response |
| Conversation History | Previous Discussion |
| Context Management | Choosing Relevant Information |
| Token Usage | AI Fuel Meter |
...
- Thinking Temperature increases intelligence.
- Confusing Temperature with Top-P.
- Believing AI remembers everything forever.
- Forgetting that AI responses also consume tokens.
- Sending unnecessary documents to the model.
- Mixing unrelated topics in one conversation.
- Confusing Training with Inference.
- Assuming the AI learns from every conversation.
- Believing one word always equals one token.
- Writing vague prompts without context.

---

# Key Takeaways

- AI processes text as tokens.
- Every model has a limited Context Window.
- Better prompts produce better responses.
- Temperature controls creativity.
- Top-P controls candidate selection.
- System Prompts define the AI's role.
- User Prompts define the user's request.
- Conversation History provides continuity.
- Context Management improves response quality.
- Every request and response consumes tokens.
- Inference generates responses using a trained model.
- Understanding these concepts is the foundation for learning RAG, AI Agents, MCP and enterprise AI development.
...
These topics build directly on the concepts you've learned today.

---

# My Notes

Use this section for your own observations, interview tips, mistakes, or project-specific learnings.

Example:

- Low Temperature works best for code generation.
- Always provide enough context for enterprise applications.
- Token usage affects both cost and performance.
- System Prompt is written by the application developer.
- Conversation History consumes the Context Window.
- Inference predicts one token at a time.
